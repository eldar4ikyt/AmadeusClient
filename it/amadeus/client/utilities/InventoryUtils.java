...
public final class InventoryUtils {
    ...
    public static void openInventory() {
        Minecraft.getMinecraft().getNetHandler().addToSendQueueNoPacket(new C16PacketClientStatus(C16PacketClientStatus.EnumState.OPEN_INVENTORY_ACHIEVEMENT));
    }

    public static void closeInventory() {
        Minecraft.getMinecraft().getNetHandler().addToSendQueueNoPacket(new C0DPacketCloseWindow(Minecraft.getMinecraft().thePlayer.inventoryContainer.windowId));
    }
    ...
    public enum ClickType {
        ...
        ClickType(final String name, final int ordinal) {
        }
    }
