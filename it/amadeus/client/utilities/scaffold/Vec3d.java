...
package it.amadeus.client.utilities.scaffold;
...
public class Vec3d
{
    ...
    public double distanceTo(final Vec3d paramVec3) {
        final double d1 = paramVec3.xCoord - this.xCoord;
        final double d2 = paramVec3.yCoord - this.yCoord;
        final double d3 = paramVec3.zCoord - this.zCoord;
