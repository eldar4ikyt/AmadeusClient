package it.amadeus.client.viamcp.protocols;
...
public enum ProtocolCollection
{
    ...
    /* 1.7.x */
    R1_7_6(new ProtocolVersion(5, -1, "1.7.10", new VersionRange("1.7", 6, 10))),
    R1_7(new ProtocolVersion(4, -1, "1.7.2", new VersionRange("1.7", 0, 5)));
