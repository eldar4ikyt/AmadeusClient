...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        this.buttonList.add(new GuiButton(2, width / 2 - 100, p_73969_1_ + (p_73969_2_ * 1), I18n.format("menu.multiplayer")));

        this.buttonList.add(new GuiButton(69, width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Accounts"));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (Reflector.FMLCommonHandler_getBrandings.exists()) {
            ...
            if (Reflector.ForgeHooksClient_renderMainMenu.exists()) {
                Reflector.call(Reflector.ForgeHooksClient_renderMainMenu, this, this.fontRendererObj, Integer.valueOf(width), Integer.valueOf(height));
            }
        } else {
        ...
        this.drawString(this.fontRendererObj, s2, width - this.fontRendererObj.getStringWidth(s2) - 2, height - 10, -1);
