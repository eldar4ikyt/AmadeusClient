    ...
    public void drawChat(int updateCounter) {
         if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            if (k > 0) {
                ...
                //mc.getAmadeus().getBlurrer().blur(0, j2 - 9,l + 4, 100,8, true, false);
                for (int i1 = 0; i1 + this.scrollPos < this.drawnChatLines.size() && i1 < i; ++i1) {
                    ChatLine chatline = this.drawnChatLines.get(i1 + this.scrollPos);

                    //mc.getAmadeus().getBlurrer().blur(0,  -i1 * 9 - 4, 20, 20, 80, true, false);
                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                           ...
                           if (l1 > 3) {
                                int i2 = 0;
                                int j2 = -i1 * 9;//double x, double y, double areaWidth, double areaHeight,float density,
    ...
    public void printChatMessageWithOptionalDeletion(IChatComponent chatComponent, int chatLineId) {
       // we want to remove instructions from index 11 - 24
        if(chatLineId < 11){
            ...
            System.out.println("[CHAT] " + chatComponent.getUnformattedText());
        }
    }
