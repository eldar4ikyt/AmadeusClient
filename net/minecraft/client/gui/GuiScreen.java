...
import it.amadeus.client.shaders.DrawShader;
import it.amadeus.client.utilities.AnimatedBG;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
   ...
   /* public void drawBackground(int tint) {
       ...
       /* Tessellator tessellator = Tessellator.getInstance();
        ...
        worldrenderer.pos(this.width, height, 0.0D).tex((float) this.width / 32.0F, (float) height / 32.0F + (float) tint).color(64, 64, 64, 255).endVertex();
