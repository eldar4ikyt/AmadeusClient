...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    {
        ChamsEvent chamsEvent = new ChamsEvent(entity,x,y,z,entityYaw, partialTicks);
        Minecraft.getMinecraft().getAmadeus().getEventManager().hook(chamsEvent);

        if(chamsEvent.isCancelled()){
            return;
        }
